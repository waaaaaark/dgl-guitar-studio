...
import SuperAdminRoster from './SuperAdminRoster'
...
export default function AdminPage() {
  ...
  const [view, setView] = useState<'roster' | 'student' | 'songs' | 'tips' | 'resources' | 'settings' | 'analytics' | 'more' | 'teacher-panel'>('roster')
  ...
  return (
    <div className="admin-sans" style={{ minHeight: '100vh', background: 'var(--bg)' }}>
      ...
      <main style={{ maxWidth: 860, margin: '0 auto', padding: '24px 20px' }}>
        ...
        {currentTeacher.role === 'super_admin' ? (
          <SuperAdminRoster
            onStudentSelect={(s: any) => { setSelectedStudent(s); setView('student') }}
